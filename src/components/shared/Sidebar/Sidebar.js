                ...
                <div className={s.sidebar} ref={sidebarRef}>
                    ...
                    <div className={s.sidebar_footer}>
                        <div className={s.col}>
                            ...
                            <Link href="https://t.me/selloutsu" className={s.sidebar_links} onClick={handleClose} target={'_blank'}>Блог</Link>
                            ...
                            <TextModal title={'Доставка, оплата, возврат'} img={payment} titleClassname={s.footer_link}>
                                ...
                                <div className={s.faq_block}>
                                    ...
                                    <LoyaltyFAQ title={'Безопасность данных'}>
                                        ...
                                        здесь</a>
                                        <br/>
                                        Все платежи проходят через интернет-эквайринг PayKeeper с использованием защиты 3d-secure.
                                        <br/>
                                        Интернет-эквайринг от PayKeeper защищен всеми нужными протоколами и имеет сертификации для создания безопасной связи между доменами при оплате. Более того, интернет-эквайринг от PayKeeper позволяет отслеживать данные по каждой транзакции (пункт товара, сумма транзакции, статус транзакции, данные покупателя) и вовремя заподозрить вредоносные операции со стороны сотрудников, покупателей или сторонних людей (мошенников).
                                    </LoyaltyFAQ>
