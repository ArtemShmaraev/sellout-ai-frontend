                            ...
                            <TextModal title={'Доставка, оплата, возврат'} img={payment} titleClassname={s.footer_link}>
                                ...
                                <div className={s.faq_block}>
                                    ...
                                    <LoyaltyFAQ title={'Безопасность данных'}>
                                        ...
                                        здесь</a>
                                        <br/>
                                        Все платежи проходят через интернет-эквайринг PayKeeper с использованием защиты
                                        3d-secure.
                                        <br/>
                                        Интернет-эквайринг от PayKeeper защищен всеми нужными протоколами и имеет
                                        сертификации для создания безопасной связи между доменами при оплате. Более
                                        того, интернет-эквайринг от PayKeeper позволяет отслеживать данные по каждой
