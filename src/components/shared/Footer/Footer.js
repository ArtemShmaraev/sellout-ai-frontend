                            ...
                            <TextModal title={'Доставка, оплата, возврат'} img={payment} titleClassname={s.footer_link}>
                                ...
                                <div className={s.faq_block}>
                                    ...
                                    <LoyaltyFAQ title={'Безопасность данных'}>
                                        ...
                                        здесь</a>
                                        <br/>
                                        Все платежи проходят через интернет-эквайринг LIFE PAY с использованием защиты
                                        3d-secure.
                                        <br/>
                                        Интернет-эквайринг от LIFE PAY защищен всеми нужными протоколами и имеет
                                        сертификации для создания безопасной связи между доменами при оплате. Более
                                        того, интернет-эквайринг от LIFE PAY позволяет отслеживать данные по каждой
                ...
                <Row className={'w-100'}>
                    <Col lg={4}>
                        <div className={s.social_media}>
                            ...
                            <div className={s.icons_block}>
                                <a href={'https://t.me/selloutsu'}>
                                    <Image src={tg} height={27} alt="" className={s.icon}/>
                                </a>
                                <a href={'https://vk.com/sellout_official'}>
                    ...
                    <Col lg={8}>
                        <h4 className={s.row2}>Подпишитесь на рассылку, чтобы быть в курсе новых поступлений и
                            акций:</h4>
                        <MailingInput/>
                    </Col>
                </Row>
