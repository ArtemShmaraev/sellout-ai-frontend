                ...
                <Modal.Body>
                    ...
                    {manySizes
                        ...
                        <div className={s.text_block}>
                            ...
                            <div className={s.faq_block}>
                                <LoyaltyFAQ title={'В чем отличия размерных таблиц на странице товара в разделе “Размерные сетки”?'}>
                                    “Основная” - таблица, созданная самим брендом.
                                    <br/>
                                    “Замеры” - таблица с замерами разных частей изделия.
                                    <br/>
                                    ”Рекомендации” - таблица с рекомендациями подходящего размера на основе измерений.
                                    <br/>
                                    ”Дополнительная” - дополнительная таблица, может быть вспомогательной для основных, если там отсутствует какой-то размерный ряд.
                                    <br/>
                        ...
                        <div className={s.text_block}>
                            ...
                            <p className={s.description}>{model}</p>
                            <p className={s.text}>Некоторые модели представлены в разных конфигурациях. Зачастую это различные комплектации товара, такие как наличие подарочной упаковки, пыльника, брендового пакета и.т.п. Это связано с тем, что один и тот же товар мы можем
                                выкупить для Вас из оффлайн бутика, интернет-магазина или частного коллекционера.
                                <br/>
                            ...
                            <div className={s.faq_block}>
                                ...
                                <LoyaltyFAQ title={'Особенности конфигураций товаров Hermès'}>
                                    У многих аксессуаров бренда Hermès существует специальные штампы, отражающие дату производства изделия, а также место и другие параметры, играющую важную роль в идентификации.
                                    <ul>
