...
const CatalogSneakersMobileMen = () => {
    const linksBrands = [
            ...
            <div className={styles.catalogContainer}>
                    ...
                    <div className={styles.categoriesGrid}>
                        {['Все кроссовки и кеды', 'Высокие кроссовки', 'Низкие кроссовки', 'Баскетбольные кроссовки', 'Футбольные бутсы', 'Кроссовки для спорта'].map((category, idx) => (
                            <div key={idx} className={styles.categoryItem}>
                                <Image
                                    src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Categories/${idx + 1}.png?v=${Date.now()}`}
                                    alt={category}
                                    width={700}
                                    height={700}
                        ...
                        {Array.from({length: 24}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                <div className={styles.circle}>
                                    <Image
                                        src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Brands/${idx + 1}.png?v=${Date.now()}`}
                                        alt="Brand Image"
                ...
                <div className={styles.brandsSection}>
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/1.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/2.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                        ...
                        <div className={`${styles.brandsGrid} ${styles.brandsGrid2}`}>
                            {Array.from({length: 24}).map((_, idx) => (
                                <div key={idx} className={styles.brandCircle}>
                                    <div className={styles.circle2}>
                                        <Image
                                            src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Jordan/${idx + 1}.png?v=${Date.now()}`}
                                            alt="Brand Image"
                                            className={styles.circleImage2}
                                            width={700}
                                            height={700}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/3.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/4.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/5.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/6.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/7.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/8.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/9.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/10.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/11.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
                    ...
                    <>
                        <div>
                            <Image
                                src={`/Images New Frontend/Mobile/Men/Products/Sneakers/Photos/12.png?v=${Date.now()}`}
                                alt=''
                                width={1000}
                                height={1000}
                                className={styles.brandsPhoto}
...
export default observer(CatalogSneakersMobileMen);