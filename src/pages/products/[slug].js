                            ...
                            <TextModal title={'Доставка, оплата, возврат'} img={payment}>
                                ...
                                <div className={s.faq_block}>
                                    ...
                                    <LoyaltyFAQ title={'Какая скорость доставки?'}>
                                        ...
                                        от одного до нескольких дней. Подробнее Вы сможете отслеживать на сайте или в приложении Boxberry.
                                ...
                                <div className={s.faq_block}>
                                    ...
                                    <LoyaltyFAQ title={'Правила возврата средства при частичной отмене заказа'}>
                                ...
                                <p className={s.text}>
                                    ...
                                    возможен в течение 30 календарных дней с момента поставки товара на зарубежный склад. Однако, срок доставки
                                    заказов от склада за рубежом до получателя в РФ может быть больше в связи с ограничениями
                                    и особенностями международной логистики. Кроме того, услуги возврата могут быть связаны с
                                    особенностями законов страны, из которой товар был для вас выкуплен. Несмотря на это SELLOUT
                                    всячески содействует по организации возврата товара продавцу. В случае обнаружения брака или
