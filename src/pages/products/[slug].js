                    ...
                    <div className={s.col2}>
                        ...
                        <div className={s.link_block}>
                            ...
                            <TextModal title={'Гарантии оригинальности и качества'} img={warranty}>
                                ...
                                <h5 className={'my-3'}>Вы можете найти нас во всех соц. сетях и посмотреть отзывы</h5>
                                ...
                                <h5 className={'my-3'}>а также изучить отзывы на интернет ресурсах</h5>
                                <Image src={patch} alt='' width={60}/>
