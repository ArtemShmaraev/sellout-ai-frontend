...
const Home = ({data}) => {
    ...
    useEffect(() => {
        if (window.scrollY !== 0) {
            ...
            // Если на верхней позиции, выполняем другое действие
            console.log('Уже на верхней позиции!');
            // Здесь можете вызвать другую функцию или выполнить другое действие
        }

        const handleScrollNew = () => {
            window.removeEventListener('scroll', handleScrollNew);
            console.log(isSeen2ndPage)
            if (!isSeen2ndPage) {
            ...
            {isDesktop ? (
                <div className={styles.pageWrapper}>
                    ...
                    <div ref={page2Ref} className={styles.page2Wrapper}>
                        <div className={`${isContentPage2Visible ? styles.buttons2pageContainer : styles.invisible}`}>
                            <button
                        ...
                        <section className={stylesMob.transitionSection}>
                            ...
                            <div className={stylesMob.animatedButtonContainer}>
                                <button
                                    ...
                                    onMouseLeave={() => setIsHoveredArrowPage1(false)} // Убери состояние hover
                                >
                                    Почему платформа Sellout <span className={stylesMob.line}></span> лучшее место для
                                    шопинга
                                </button>
                    ...
                    <div className={stylesMob.pages27Wrapper}>
                        ...
                        <div ref={page2Ref} className={stylesMob.page2Wrapper}>
                            ...
                            <div
                                ...
                                <div className={`${isBlocksPage2Visible ? stylesMob.logosSlide : stylesMob.invisible}`}>
                                    <Image
                                        src="/img/MainImg/manyLogos1Page2.png"
                                        alt="Image 1"
                        ...
                        <div ref={page3Ref} className={stylesMob.page3Wrapper}>
                            ...
                            <div className={`${isContentPage2Visible ? stylesMob.page3Images : stylesMob.invisible}`}>
                        ...
                        <div className={stylesMob.pages47Wrapper}>
                            ...
                            <div ref={page4Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page471}>
                                    <Image src="/img/MainImg/Как работаем 1 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page5Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Как работаем 2 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page6Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Как работаем 3 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page7Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Гарантии 1 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page8Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/гарантии 2 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page9Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Гарантии 3 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page10Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Гарантии 4 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page11Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Гарантии 5 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page12Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Гарантии 6 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page13Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Гарантии 7 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page14Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Гарантии 8 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            ...
                            <div ref={page19Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Философия 1 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page20Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Философия 2 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page21Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Философия 3 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page22Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Философия 4 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
                            <div ref={page23Ref} className={stylesMob.page47Wrapper}>
                                <div className={stylesMob.page47}>
                                    <Image src="/img/MainImg/Философия 5 mob.png" alt="Img" width={6000} height={2000}
                                           className={stylesMob.page47Img}/>
                                </div>
                            </div>
