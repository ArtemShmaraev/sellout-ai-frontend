...
const CatalogClothesDesktopMen = () => {
    const linksBrands = [
                        ...
                        {Array.from({length: 60}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                <div className={styles.circle}>
                                    <Image
                                        src={`/Images New Frontend/Mobile/Men/Products/Clothes/Brands/${idx + 1}.png?v=${Date.now()}`}
                                        alt="Brand Image"
                    ...
                    <div className={styles.categoriesGrid}>
                        {['Футболки', 'Худи', 'Шорты', 'Лонгсливы', 'Свитеры', 'Поло'].map((category, idx) => (
                            <div key={idx} className={styles.categoryItem}>
                                <Image
                                    src={`/Images New Frontend/Mobile/Men/Products/Clothes/Categories/${idx + 1}.png?v=${Date.now()}`}
                                    alt={category}
                                    width={700}
                                    height={700}
                    ...
                    <div className={styles.categoriesGrid4}>
                        {['Рубашки', 'Треники', 'Джинсы', 'Брюки'].map((category, idx) => (
                            <div key={idx} className={styles.categoryItem4}>
                                <Image
                                    src={`/Images New Frontend/Mobile/Men/Products/Clothes/Categories/${idx + 7}.png?v=${Date.now()}`}
                                    alt={category}
                                    width={700}
                                    height={700}
                ...
                <div className={styles.categoriesSection2}>
                    ...
                    <div className={styles.categoriesGrid4}>
                        {['Вся', 'Баскет. джерси', 'Баскет. шорты', 'Футб. майки', 'Футб. шорты', 'Шорты', 'Майки'].map((category, idx) => (
                            <div key={idx} className={styles.categoryItem4}>
                                <Image
                                    src={`/Images New Frontend/Mobile/Men/Products/Clothes/Categories/${idx + 11}.png?v=${Date.now()}`}
                                    alt={category}
                                    width={700}
                                    height={700}
                                    className={styles.categoryImage4}
                ...
                <div className={styles.categoriesSection2}>
                    ...
                    <div className={styles.categoriesGrid4}>
                        {['Вся', 'Куртки', 'Ветровки', 'Жилетки', 'Пуховики', 'Пальто', 'Бейсбольные', 'Джинсовые', 'Кожаные', 'Плащи'].map((category, idx) => (
                            <div key={idx} className={styles.categoryItem4}>
                                <Image
                                    src={`/Images New Frontend/Mobile/Men/Products/Clothes/Categories/${idx + 18}.png?v=${Date.now()}`}
                                    alt={category}
                                    width={700}
                                    height={700}
                                    className={styles.categoryImage4}
                ...
                <div className={styles.categoriesSection2} style={{marginBottom: '50px'}}>
                    ...
                    <div className={styles.categoriesGrid4}>
                        {['Деним', 'Пиджаки', 'Костюмы', 'Зимние штаны', 'Плавки', 'Комбинезоны', 'Носки', 'Трусы'].map((category, idx) => (
                            <div key={idx} className={styles.categoryItem4}>
                                <Image
                                    src={`/Images New Frontend/Mobile/Men/Products/Clothes/Categories/${idx + 36}.png?v=${Date.now()}`}
                                    alt={category}
                                    width={700}
                                    height={700}
                                    className={styles.categoryImage4}
...
export default observer(CatalogClothesDesktopMen);